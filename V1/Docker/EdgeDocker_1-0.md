...
To use a port other than 5590, see [System port configuration](xref:SystemPortConfiguration1-0). Changing the configuration of EDS running in the container changes the port exposed to the local machine.
