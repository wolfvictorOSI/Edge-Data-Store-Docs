...
| **ApplyPrefixToStreamID** | Optional | `boolean` | No |  When set to `true`, the StreamIdPrefix that you defined will be applied to StreamId strings specified in data selection configuration. The default setting is false.
