...
In order to provide the necessary information for the Modbus TCP EDS adapter to be ready for data collection, you need to configure the adapter. For more details, see [Modbus TCP data source configuration](#modbus-tcp-data-source-configuration) and [Modbus TCP data selection configuration](#modbus-tcp-data-selection-configuration). To configure the adapter, do the following:
...
> **Note:** Naming convention is affected by StreamIdPrefix and ApplyPrefixToStreamID settings in data source configuration. For more information, refer to [OPC UA data source configuration](#opc-ua-data-source-configuration).
...
> **Note:** You cannot modify Modbus TCP data source configuration manually. You must use the REST endpoints to add or edit the configuration.
...
> **Note:** You cannot modify Modbus TCP data selection configuration manually. You must use the REST endpoints to add or edit the configuration.
