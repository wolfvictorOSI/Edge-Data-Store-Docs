...
The following quick start guides will help you get started with Edge Data Store, its components and utilities:

- [OPC UA quick start](xref:opcUaQuickStart)
- [Modbus TCP quick start](xref:modbusQuickStart)
