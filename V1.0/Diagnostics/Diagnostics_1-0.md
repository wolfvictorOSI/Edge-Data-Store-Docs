...
Diagnostic data is stored within the _diagnostics_ namespace in Edge Storage. Local access to this data is available through SDS. For more information, see [Reading data](xref:sdsReadingData1-0).
