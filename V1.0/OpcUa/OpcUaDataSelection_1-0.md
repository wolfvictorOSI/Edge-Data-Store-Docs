...
> **Note:** To avoid possibly expensive browse operations, OSIsoft recommends that you manually create a data selection file instead of generating the default data selection file. For more information, see [Data selection configuration](xref:OPCUADataSelectionConfiguration1-0).

Complete the following steps in order for this default data selection file to be generated:

1. Add an [OPC UA EDS adapter](xref:EdgeDataStoreConfiguration1-0) with a unique ComponentId. 
...
2. Configure a valid [OPC UA data source](xref:opcUaOverview1-0).
